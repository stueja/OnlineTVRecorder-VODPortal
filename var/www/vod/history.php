...
$cmd = exec("ls -alt content/*/*.mp4 | tail -n 1 | cut -d' ' -f 7-8",$oldestmp4);
$cmd = exec("ls -alt content/*/*.mp4 | head -n 1 | cut -d' ' -f 9-10",$youngestmp4);

$cmd = exec("basename $(ls -alt content/*/*.mp4 | tail -n 1 | cut -d' ' -f 10)",$oldestmp4name);

$cmd = exec("ls -alt content/*/*.avi | tail -n 1 | cut -d' ' -f 7-8",$oldestavi);
$cmd = exec("ls -alt content/*/*.avi | head -n 1 | cut -d' ' -f 9-10",$youngestavi);

$cmd = exec("ls -alt content/*/*.mp3 | tail -n 1 | cut -d' ' -f 7-8",$oldestmp3);
$cmd = exec("ls -alt content/*/*.mp3 | head -n 1 | cut -d' ' -f 9-10",$youngestmp3);

$cmd = exec("ls content/*/*.mp4 | wc -l", $countmp4);
$cmd = exec("ls content/*/*.avi | wc -l", $countavi);
$cmd = exec("ls content/*/*.mp3 | wc -l", $countmp3);
			...
			<div class="show-top-grids">
				<div class="main-grids news-main-grids">
					<div class="recommended-info">
						...
						<p class="history-text">Daten über das Videoportal.
						</p>
						<div class="history-grids">
							<div class="col-md-1 history-left">
								<p><?php echo "$countmp4[0]"?></p>
							</div>
						...
						<div class="history-grids">
							<div class="col-md-1 history-left">
								<p><?php echo "$oldestmp4[0]\n$youngestmp4[0]"?></p>
							</div>
							<div class="col-md-11 history-right">
								<h5>oldest/youngest mp4</h5>
								<p>oldest mp4: <?php echo "$oldestmp4name[0]" ?></p>
							</div>
							<div class="clearfix"> </div>
						</div>
						<div class="history-grids">
