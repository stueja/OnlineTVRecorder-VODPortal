...
// TODO:
// - falls vorhanden, mehrere Qualitäten anbieten
...
$dirlist = getFileList("content/", false, $voddata);
        ...
        <div class="col-sm-9 col-sm-offset-3 col-md-10 col-md-offset-2 main">
			<div class="show-top-grids">
				<div class="col-sm-8 single-left">
					<div class="song">
						<div class="song-info">
							<h3><?php echo "{$file['titel']}"; ?></h3>	
					</div>
						<div class="video-grid">
							<!-- funktioniert nicht mit iphone -->
							<iframe src="player.inc.php?v=<?php echo "$video"; ?>" allowfullscreen></iframe>
						</div>
						<div class="video-grid">
							<!-- funktioniert nicht mit iphone -->						
